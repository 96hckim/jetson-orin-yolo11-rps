...
class VisionConfig:
    ...
    engine_path: Path = _PROJECT_ROOT / "models" / "rps_yolo11n_custom_640.engine"
...
class GamePlayConfig:
    ...
    target_score: int = 3  # 세트 승리 점수 (5판 3선승제 등)
...
class AppConfig:
    ...
    game: GamePlayConfig = field(default_factory=GamePlayConfig)
